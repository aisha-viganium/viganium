...
export default function AddQuestion() {
  ...
  return (
    <>
      <form onSubmit={handleSubmit} className="flex flex-col gap-6 md:max-w-[80%]">
        <label
        ...
        <div className="flex md:flex-row items-stretch md:items-center md:w-[543px]">
          <input
            type="text"
            id="question"
            ...
            className={`${isArabic ? "md:rounded-r-[8px] rounded-l-none" : "md:rounded-l-[8px] rounded-r-none"} outline-none flex-1 p-4 h-[57px] bg-[#1A1A1A] border border-[#C2C2C2] rounded-lg  font-semibold font-brando-semibold text-[16px] md:text-[18px] lg:text-[20px] leading-[26px] text-white placeholder:text-white md:w-[479px]`}
          />
          <button
            type="submit"
