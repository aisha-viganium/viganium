...
export default function ChatCard() {
    ...
    const categories = ["برمجة المواقع الإلأكترونية", "إستشارات الأمن السيبرانية", "برمجة تطبيقات الجوال", "تطوير البرمجيات المخصصة","التسليمات البرمجية","خدمات تكنولوجيا المعلومات","وكيل الذكاء الإصطناعي","التسويق الإلكتروني","اتممة الذكاء الإصطناعي","التخزين بواطة البلوك اتشين"];
                    ...
                    <div className="flex flex-wrap gap-2 max-w-[710px] justify-center mx-auto mt-6 z-50">
                        {categories.map((c) => (
                            <button
                                ...
                                type="button"
                                onClick={() => openChat()}
                                className="cursor-pointer flex justify-center items-center py-1 px-3 md:px-4 gap-[6px] md:gap-[10px] w-[140px] md:w-[218px] h-[34px] bg-white rounded-[20px] font-medium text-[14px] md:text-[16px] leading-[20px] md:leading-[23px] text-[#1A1A1A]"
                            >
                                {c}
                            </button>
                        ))}
