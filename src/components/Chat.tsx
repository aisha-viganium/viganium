        ...
        <div className="relative flex flex-col justify-between w-full max-w-[921px] min-h-[469px] md:h-[727px] rounded-[30px] md:rounded-[50px] bg-black p-6 md:p-10">
          ...
          <div className="mt-6 md:mt-4 cursor-pointer border-t border-[#FEFEFE] drop-shadow-[0_4px_4px_rgba(0,0,0,0.25)] p-4 md:p-[33px]">
            ...
            >
              ...
              />
              <span className={`font-semibold font-brando-semibold text-[12px] md:text-[24px] leading-[26px] md:leading-[34px] text-white ${isArabic ? "text-right placeholder:text-right" : "text-left placeholder:text-left"}`}>
            ...
            <div className="border-t border-[#FEFEFE] drop-shadow-[0_4px_4px_rgba(0,0,0,0.25)] p-4 md:p-[33px]">
              <div className="flex items-center gap-2">
                ...
                <input
                  ...
                  className={`flex-1 bg-transparent font-semibold font-brando-semibold text-[12px] md:text-[24px] ${isArabic ? "text-right placeholder:text-right" : "text-left placeholder:text-left"} text-white placeholder:text-white outline-none`}
