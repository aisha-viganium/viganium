...
export default function ChatCard() {
  ...
  const categories = [
    "برمجة المواقع الإلأكترونية",
    "إستشارات الأمن السيبرانية",
    "برمجة تطبيقات الجوال",
    "تطوير البرمجيات المخصصة",
    "التسليمات البرمجية",
    "خدمات تكنولوجيا المعلومات",
    "وكيل الذكاء الإصطناعي",
    "التسويق الإلكتروني",
    "اتممة الذكاء الإصطناعي",
    "التخزين بواطة البلوك اتشين",
  ];
    ...
    setTimeout(() => {
      setMessages((m) => [
        ...m,
        {
          id: Date.now() + 1,
          from: "bot",
          text: `رد تلقائي على: “${userMsg.text}”`,
        },
      ]);
    }, 700);
  }

  // ⬇️ نخلي الكونتينر ينزل لآخر رسالة بس
  useEffect(() => {
