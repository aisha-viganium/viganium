...
export default function ReviewSlider({ reviews }: { reviews: Review[] }) {
  return (
    <div className="relative h-[60vh] md:min-h-[100vh] overflow-hidden px-2 md:px-0 ">
      <div className="absolute w-full h-[40vh]  md:min-h-[620px] left-0 bottom-0 bg-no-repeat bg-[url('/assets/images/RectangleBackground.svg')] bg-cover bg-center overflow-hidden"></div>
          ...
          {reviews.map((review) => (
            <SwiperSlide key={review.id} className="min-h-[700px] sm:min-h-[900px]">
              <div className="relative flex flex-col items-center px-4">
                <div className="relative w-full sm:w-[1057px] h-[219px] sm:h-[419px] overflow-hidden rounded-[20px] sm:rounded-[34px] mt-0  md:mt-10 sm:mt-20 clipPath-video">
                ...
                <div className="relative w-full sm:w-[1057px] mt-[-300px] sm:mt-[-200px]">
                  <Image
                    src="/assets/icons/rectangle-yellow.svg"
                    alt="yellow"
                    width={971}
                    height={217}
                    className="absolute -z-1 md:z-1 right-[5%] top-[66%] md:right-[-5%] md:top-[45%] w-[80%] sm:w-[971px] h-[150px] sm:h-[217px] bg-[#F9C751] rounded-[20px] sm:rounded-[34px]"
                    style={{
                      transform: "matrix(-0.98, 0.21, 0.21, 0.98, 0, 0)",
                    }}
                  />

                  <span className="absolute top-[45%] md:top-4 sm:top-10 right-0 flex gap-2 z-50">
                    <Image
                  ...
                  <div style={{ filter: "drop-shadow(0px 8px 20px rgba(0,0,0,0.4))" }}
                    className="relative z-10  min-h-[300px] sm:min-h-[475px] py-6 px-4 sm:py-8 sm:px-6 bg-[#FDFFFC] shadow rounded-[20px] sm:rounded-[34px] flex flex-col gap-6 pt-[180px] md:pt-[150px] clipPath-review mt-[70px] md:mt-0">
                  ...
                  ">
                    ...
                    <div className="flex justify-start items-center gap-2 mt-auto">
                      {Array.from({ length: review.rating }, (_, i) => (
                        <Image key={i} src="/assets/icons/star.svg" width={10} height={10} className="sm:w-[28px] sm:h-[28px]" alt="star" />
                      ))}
