...
export default function CardsDiv() {
  ...
  const positions = [
    ...
    { card: "top-[25%] right-[10%] md:top-20 md:right-1 2xl:right-50 w-[113px] h-[142px] md:w-[213px] md:h-[242px]", title: "top-[45px] md:top-[85px] right-[15px] text-[15px] md:text-[26px] " },
    { card: "bottom-[25%] left-[10%] md:bottom-5 2xl:bottom-20 md:left-10 2xl:left-40 w-[113px] h-[142px] md:w-[213px] md:h-[242px]", title: "top-[55px] md:top-[105px] right-[7px] text-[14px] md:text-[22px]" },
