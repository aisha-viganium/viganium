    ...
    <section className="py-5 md:py-16 px-2 md:px-5 container mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start mt-3 md:mt-16">
        <AnimatedSection variants={slideFromRightBounce} className="col-span-1">
          ...
          <h3 className="flex flex-wrap gap-3 md:gap-5 items-center font-bold text-[16px] md:text-2xl lg:text-[32px] leading-tight lg:leading-[46px] text-center text-[#1A1A1A]">
