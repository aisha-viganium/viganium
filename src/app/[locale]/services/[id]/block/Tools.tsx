                    ...
                    >
                        {slides.map((slide) => (
                            <SwiperSlide key={slide.id}>
                                <div className="flex flex-row justify-between items-center px-4 md:px-6 py-4 gap-2 md:gap-2.5 max-w-full md:max-w-[454px] h-[80px] md:h-[96px] bg-[#EFEFEF] rounded-[12px] md:rounded-[16px] mx-auto">
                                    <Image
                                        src={slide.icon}
                                        alt={`icon-${slide.id}`}
                                        width={40}
