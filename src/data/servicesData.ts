    ...
    ar: [
        {
            ...
            tags: [1, 2],
            tagsDisplayed: ["التطوير التقني", "الابتكار الرقمي"],
            description: "كل مشروع له بصمته، وإحنا نبرمجها لك على مقاسك.",
            serviceDescriptionTitle:
                "بصفتنا شركة برمجة سعودية، نفهم احتياج السوق ونطوّر حلول برمجية مرنة تخدم عملك وتسهّل شغلك اليومي.",
            serviceDescriptionParagraph:
                "نصمّم ونطوّر أنظمة تفهم طريقة عملك وتتكيف معها. \n  من الأنظمة المؤسسية الداخلية إلى تطبيقات الويب الذكية، نبني برمجيات مصمّمة بعناية لتسهّل الإدارة وتزيد الكفاءة. \n نهتم إن التقنية تشتغل لخدمتك، بخطوات واضحة وأداء آمن يواكب نمو عملك بثقة.",
            list: [
                {
                    title: "أنظمة موارد",
                    description: " نطوّر أنظمة ERP متكاملة تربط كل أقسام العمل في منصة واحدة تسهّل الإدارة وتزيد الكفاءة."
                },
                {
                    title: "تحليل بيانات",
                    description: " نحول الأرقام إلى قرارات عبر لوحات تحكّم تفاعلية تعرض الأداء بشكل بصري وذكي."
                },
                {
                    title: "واجهات برمجة",
                    description: " نبني APIs آمنة وسريعة تضمن تواصل سلس بين أنظمتك وتطبيقاتك المختلفة."
                },
                {
                    title: "تكامل سحابي",
                    description: " نربط بين أنظمتك والسحابة لسهولة الوصول واستمرارية العمل في أي وقت ومكان."

                },
                {
                    title: "خدمات مصغّرة",
                    description: " نصمم حلول Microservices مرنة وقابلة للتوسّع، ترفع الأداء وتسهّل التحديثات."
                },
                {
                    title: "إدارة صلاحيات",
                    description: " نوفّر أنظمة تحكّم دقيقة بالمستخدمين تضمن الأمان والتنظيم داخل بيئة العمل."
                }
            ],
            tools: [
                {
        ...
        },
        {
            ...
            tags: [1, 2],
            tagsDisplayed: ["التطوير التقني", "الابتكار الرقمي"],
            description: "تطبيقك مو مجرد فكرة إحنا نحوله لتجربة حقيقية في يد المستخدم.",
            serviceDescriptionTitle:
                "في فيجانيوم نطوّر تطبيقات موبايل احترافية لأنظمة iOS وAndroid بتصميم جذّاب وأداء مستقر. \n نهتم إن التطبيق يكون سريع، سلس، ومبني على تجربة مستخدم فعّالة تواكب احتيجاتك.",
            serviceDescriptionParagraph:
                "نشتغل على كل مشروع كأنه تجربة فريدة تستحق الإتقان. \n نبدأ من دراسة فكرة التطبيق وسلوك المستخدم، نصمّم تجربة جذابة وسلسة، ثم نطوّر الكود بأعلى معايير الأداء والأمان. \n هدفنا ما هو مجرد “تطبيق يشتغل”، بل منتج رقمي يخدمك، يعكس هويتك، ويصمد في السوق بثقة.",
            list: [
                {
                    title: "تجربة مستخدم",
            ...
            tools: [
                {
                    title: "Native and Hybrid Applications",
                    image: "/assets/icons/html.svg"
                },
                {
                    title: "Backend Integration Support",
                    image: "/assets/icons/html.svg"
                },
                {
                    title: "Database Management",
            ...
            tags: [1, 2, 3],
            tagsDisplayed: ["التطوير التقني", "الابتكار الرقمي", "التسويق الذكي"],
            description: "موقعك هو واجهتك الأولى وخبرتنا تخليه يحكي قصتك بأفضل صورة.",
            serviceDescriptionTitle:
                "في فيجانيوم نطوّر مواقع إلكترونية تجمع بين السرعة، الجمال، والتقنية. \n نهتم بتصميم مواقع تبرز هوية مشروعك، وتحوّل الزوار إلى عملاء فعليين، مع توافق تام مع محركات البحث وتجربة استخدام ذكية على كل الأجهزة.",
            serviceDescriptionParagraph:
                "موقعك هو أول انطباع عنك، واهتمامنا إن الانطباع يكون يعلق. \n نبدأ من هوية مشروعك، ونبني موقع يعبّر عنك بصريًا ويشتغل بسرعة على كل الأجهزة. \n نهتم إن الزائر يوصل للي يبيه بثلاث ضغطات أو أقل تجربة ذكية تعكس احترافك وتزيد ثقة عملاءك.",
            list: [
                {
                    title: "تصميم واجهات",
                    description: "نرسم واجهات حديثة تعكس هوية مشروعك وتقدّم تجربة تصفح ممتعة وسلسة."
                },
                {
                    title: "برمجة حديثة",
                    description: "نستخدم أحدث لغات وأطر التطوير لضمان الأداء السريع والثابت."
                },
                {
                    title: "تحسين SEO",
                    description: "نهيّئ موقعك لمحركات البحث لزيادة الظهور والوصول لعملاء جدد."
                },
                {
                    title: "تكامل ذكي",
                    description: "نربط الموقع مع التحليلات، الدفع الإلكتروني، وقواعد البيانات بسهولة."

                },
                {
                    title: "إدارة محتوى",
                    description: "نوفّر نظام إدارة محتوى مرن يخليك تتحكم في كل تفصيلة بنفسك."
                },
                {
                    title: "صيانة مستمرة",
                    description: "نتابع أداء الموقع ونقدّم تحديثات أمان وتحسينات دورية."
                }
            ],
            tools: [
                {
            ...
            description: "الذكاء الاصطناعي مو رفاهية صار ضرورة لأي بزنس يبغى يتطوّر.",
            serviceDescriptionTitle:
                "وكيل الذكاء الاصطناعي من فيجانيوم هو مساعد ذكي يشتغل 24 ساعة في اليوم، يفهم عملاءك، يرد عليهم، ويتعلم منهم. \n نستخدم أحدث تقنيات NLP وMachine Learning عشان نحسّن تجربة المستخدم ونرفع كفاءة التشغيل.",
            serviceDescriptionParagraph:
                "ما نبرمج روبوت يرد، نطوّر وكيل يفهم. \n ندرّب الذكاء الاصطناعي على لغتك، منتجاتك، وطريقة تواصلك مع عملاءك. \n هدفنا نخلق مساعد رقمي يعرف متى يجاوب، ومتى يقترح، ومتى يتعلّم — كأنه عضو حقيقي في فريقك.",
            list: [
                {
                    title: "تفاعل ذكي",
                    description: "يتحدث الوكيل مع العملاء ويفهم السياق بدقة واستجابة فورية."
                },
                {
                    title: "تعلم مستمر",
                    description: "يطوّر نفسه تلقائيًا من كل محادثة لتحسين التجربة بمرور الوقت."
                },
                {
                    title: "تكامل سهل",
                    description: "يتصل بأنظمتك الحالية مثل CRM والموقع والسوشيال ميديا بسهولة."
                },
                {
                    title: "لغات متعددة",
                    description: " يتعامل مع عملائك بأي لغة يدعمها عملك، بدقة وفهم طبيعي."

                },
                {
                    title: "تحليل أداء",
                    description: "لوحة تحكّم تتابع المحادثات وتقترح تحسينات مستمرة."
                },
                {
                    title: "أمان عالي",
                    description: " نحمي بيانات العملاء والمحادثات بمعايير أمان مشددة."
                }
            ],
            tools: [
                {
            ...
            serviceDescriptionParagraph:
                "ندمج التحليل بالابتكار، ونخلّي الأرقام تحكي قصتك. \n ندرس السوق، نرسم الاستراتيجية، ونصمم حملات تلمس جمهورك صح. \n هدفنا مو بس “تفاعل”، بل نتائج ملموسة ترفع الوعي والمبيعات معًا.",
            list: [
                {
            ...
            id: 6,
            name: "التشغيل الذكي بالذكاء الاصطناعي",
            ...
            serviceDescriptionParagraph:
                "ما نوفّر أدوات، نخلق منظومة تشتغل لحالها. \n نحلل العمليات خطوة بخطوة ونبني حلول ذكية تختصر الوقت وتقلّل الأخطاء. \n نؤمن إن السرعة مو رفاهية، هي معيار النجاح في السوق اليوم.",
            list: [
                {
                    title: "تحليل عمليات",
            ...
            serviceDescriptionParagraph:
                "نراجع كل تفصيلة كأننا المستخدم النهائي. \n  نختبر الأداء، الأمان، التجربة، ونصحّح قبل ما يكتشفها العميل.\n  الجودة بالنسبة لنا ما هي “مرحلة أخيرة”، هي مبدأ في كل سطر كود.",
            list: [
                {
                    title: "اختبار وظيفي",
            ...
            id: 8,
            name: "إنتاج الفيديو باستخدام الذكاء الاصطناعي",
            ...
            serviceDescriptionParagraph:
                "نحول الأفكار إلى مشاهد حقيقية تخاطب العين والعقل. \n نستخدم أحدث أدوات الذكاء الاصطناعي لتحويل النص إلى فيديو واقعي خلال دقائق. \n هدفنا نوصل رسالتك بسرعة، بجودة، وبصوت يعبّر عن هويتك.",
            list: [
                {
                    title: "تحويل نصوص",
            ...
            id: 9,
            name: "تخزين البيانات باستخدام البلوك تشين",
            image: "/assets/images/services/block-chain.png",
            tags: [1, 4],
            tagsDisplayed: ["التطوير التقني", "الأمان والتشغيل الذكي"],
            description: "بياناتك تستحق أمان المستقبل.",
            serviceDescriptionTitle:
                "في عالم يعتمد على المعلومة، حماية البيانات صارت ضرورة. \n نقدّم في Viganium حلول تخزين لامركزية تعتمد على تقنية البلوك تشين لضمان الأمان، الشفافية، وتقليل المخاطر. \n حلولنا ما تحفظ بياناتك بس، بل تحميها وتمنحك تحكّم كامل فيها.",
            serviceDescriptionParagraph:
                "نوفّر حلول أمان ما تتأثر بالزمن. \n نستخدم تقنيات البلوك تشين لتخزين بياناتك بطريقة لامركزية آمنة وشفافة. \n بياناتك تظل ملكك، مش عند أي خادم خارجي، وهذا اللي يفرقنا.",
            list: [
                {
                    title: "تخزين لامركزي",
            ...
            id: 10,
            name: "الاستشارات الأمنية السيبرانية",
...

        {
            ...
            serviceDescriptionTitle:
                "نهتم بتصميم واجهات تجمع بين الجمال والسهولة. \nنصمم UI/UX عصري يخلّي المستخدم يعيش تجربة مريحة وسلسة تخدم هدفك التجاري وتعبّر عن علامتك بوضوح.",
            serviceDescriptionParagraph:
...

        {
            ...
            list: [
                ...
                { title: "تنسيق فرق", description: "نضمن تواصل فعال بين فرق التطوير، التصميم، والتسويق." },
